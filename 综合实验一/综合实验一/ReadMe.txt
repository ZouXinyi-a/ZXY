...
应用程序向导已为您创建了这个 综合实验一 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
综合实验一.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 C综合实验一App 应用程序类。

综合实验一.cpp
这是包含应用程序类 C综合实验一App 的主要应用程序源文件。

综合实验一.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\综合实验一.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 综合实验一.rc 中。
...
综合实验一View.h，综合实验一View.cpp - 文档的视图
这些文件包含 C综合实验一View 类。
...
这些文件包含 C综合实验一Set 类。此类用于访问您在向导中选择的数据源。
将不添加序列化支持。
