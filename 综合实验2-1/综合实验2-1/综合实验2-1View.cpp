...
C综合实验21View::C综合实验21View()
	: CRecordView(C综合实验21View::IDD)
	, photoname(_T(""))
{
	m_pSet = NULL;
	// TODO: 在此处添加构造代码
	path = _T("D:\\电子板报\\五张相片.图片\\");
...
void C综合实验21View::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void C综合实验21View::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
